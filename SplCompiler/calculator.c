...
void prg_Calculator()
{
	...
	char spl_choice = 1;
	int spl_iA = 1, spl_iB = 1, spl_iRes = 1;
	...
	do
	{
		printf("Please%cselect%can%coperation%c%cAddition%c%ca%c%c%cSubtraction%c%cs%c%c%cDivision%c%cd%c%c%cMultipulcation%c%cm%c%c%cOr%cto%cquit%c%cq%c%c", spl_space, spl_space, spl_space, spl_period, spl_space, spl_space, spl_bra, spl_ket, spl_period, spl_space, spl_space, spl_bra, spl_ket, spl_period, spl_space, spl_space, spl_bra, spl_ket, spl_period, spl_space, spl_space, spl_bra, spl_ket, spl_period, spl_space, spl_space, spl_space, spl_space, spl_bra, spl_ket, spl_period);
		printf("\n");
		{
