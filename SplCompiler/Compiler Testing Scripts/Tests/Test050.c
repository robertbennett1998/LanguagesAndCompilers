/*WARNING (10:8): spl_x is used before it has been assigned to, this will have unexpected consequences!*/
#include <stdio.h>
...
/*WARNING (16:10): spl_x is declared and used but never assigned to, this may have unexpected consequences!*/
